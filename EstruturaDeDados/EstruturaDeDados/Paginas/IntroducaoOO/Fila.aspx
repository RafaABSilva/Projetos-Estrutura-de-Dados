<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fila.aspx.cs" Inherits="Paginas_IntroducaoOO_Fila" %>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Hey! Dá uma olhadinha nisso antes!</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Você realmete deseja apagar <b>TODOS</b> os elementos da fila?<br />
                            Isso não parece ser uma boa ideia :/
                        </div>
                        <div class="modal-footer">
                            <a class="btn btn-secondary" data-dismiss="modal">É verdade... Fecha Aê!</a>
                            <asp:Button ID="btnZerarFila" runat="server" CssClass="btn btn-danger" Text="Tô Ligado! Taca fogo em tudo!" OnClick="btnZerarFila_Click" />
                        </div>
                    </div>
                </div>
            </div>
